...
class RefreshCommand(StewBaseCommand):
    ...
    arguments = [Argument("project-name", required=False, is_list=False, description="The name of the project to refresh. If not provided, all projects will be refreshed.")]
