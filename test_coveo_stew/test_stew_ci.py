...
content-hash = "c692fc1f973140ab569982958e5e02d4f3bef4cebdb99338d113cbd6f3a4a556"
"""
...
def linter_project(tmp_path_factory: TempPathFactory) -> PythonProject:
    ...
    project = PythonProject(NullIO(), tmpdir)
...
def write_code(project: PythonProject, code: str) -> Generator[None, None, None]:
    code_file = project.project_path / project.poetry.package.pretty_name / "code.py"
